...
def main():
    ...
    print("=" * 60)
    print("XGBoost + PharmHGT-style Featurization for Gamma_max Prediction")
    print("=" * 60)
    ...
    for rank, t in enumerate(top_k):
        ...
        y_holdout_orig = y_holdout / Y_SCALE
        ho_rmse = np.sqrt(mean_squared_error(y_holdout_orig, y_pred_ho))
        ho_r2 = r2_score(y_holdout_orig, y_pred_ho)
    ...
    try:
        ...
        fig.suptitle('XGBoost + PharmHGT Features - Gamma_max Prediction', fontsize=14)
    ...
    print(f"  Best CV RMSE: {study.best_value / Y_SCALE:.4f}")
    ...
    metrics = {
        ...
        'best_cv_rmse': round(study.best_value / Y_SCALE, 4),
