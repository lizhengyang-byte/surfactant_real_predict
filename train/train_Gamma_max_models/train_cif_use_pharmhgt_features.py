...
def main():
    ...
    print("=" * 60)
    print("Conditional Inference Forest + PharmHGT-style Featurization for Gamma_max Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('Conditional Inference Forest + PharmHGT Features - Gamma_max Prediction', fontsize=14)
