...
def main():
    ...
    print("=" * 60)
    print("NGBoost + PharmHGT-style Featurization for Gamma_max Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('NGBoost + PharmHGT Features - Gamma_max Prediction', fontsize=14)

        # Pred vs True with error bars (1 std)
        ax = axes[0]
        y_std = y_dist.std()
        ax.errorbar(y_test_orig, y_pred, yerr=y_std, fmt='o', alpha=0.5,
