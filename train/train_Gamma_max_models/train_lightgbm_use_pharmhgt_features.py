...
def main():
    ...
    print("=" * 60)
    print("LightGBM + PharmHGT-style Featurization for Gamma_max Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('LightGBM + PharmHGT Features — Gamma_max Prediction', fontsize=14)
