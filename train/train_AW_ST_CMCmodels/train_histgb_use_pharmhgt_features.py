...
def main():
    ...
    print("=" * 60)
    print("HistGradientBoosting + PharmHGT-style Featurization for LogCMC AW_ST_CMC Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('HistGradientBoosting + PharmHGT Features - AW_ST_CMC Prediction', fontsize=14)
