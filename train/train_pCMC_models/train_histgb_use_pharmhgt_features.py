...
def main():
    ...
    print("=" * 60)
    print("HistGradientBoosting + PharmHGT-style Featurization for LogCMC (pCMC) Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('HistGradientBoosting + PharmHGT Features - pCMC Prediction', fontsize=14)
