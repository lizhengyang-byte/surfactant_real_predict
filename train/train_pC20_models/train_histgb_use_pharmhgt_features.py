...
def main():
    ...
    print("=" * 60)
    print("HistGradientBoosting + PharmHGT-style Featurization for pC20 Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('HistGradientBoosting + PharmHGT Features - pC20 Prediction', fontsize=14)
        ...
        ax.set_xlabel('True pC20'); ax.set_ylabel('Predicted pC20')
        ...
        ax.set_xlabel('Predicted pC20'); ax.set_ylabel('Residuals')
