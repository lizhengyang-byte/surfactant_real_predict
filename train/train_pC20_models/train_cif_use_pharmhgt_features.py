...
def main():
    ...
    print("=" * 60)
    print("Conditional Inference Forest + PharmHGT-style Featurization for pC20 Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('Conditional Inference Forest + PharmHGT Features - pC20 Prediction', fontsize=14)
