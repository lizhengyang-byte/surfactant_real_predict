...
def main():
    ...
    print("=" * 60)
    print("Conditional Inference Forest + PharmHGT-style Featurization for Pi_CMC Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('Conditional Inference Forest + PharmHGT Features - Pi_CMC Prediction', fontsize=14)
