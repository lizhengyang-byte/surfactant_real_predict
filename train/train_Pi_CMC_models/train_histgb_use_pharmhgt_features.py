...
def main():
    ...
    print("=" * 60)
    print("HistGradientBoosting + PharmHGT-style Featurization for Pi_CMC Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('HistGradientBoosting + PharmHGT Features - Pi_CMC Prediction', fontsize=14)
        ...
        ax.set_xlabel('True Pi_CMC'); ax.set_ylabel('Predicted Pi_CMC')
        ...
        ax.set_xlabel('Predicted Pi_CMC'); ax.set_ylabel('Residuals')
