...
def main():
    ...
    print("=" * 60)
    print("HistGradientBoosting + PharmHGT-style Featurization for Area_min Prediction")
    print("=" * 60)
    ...
    try:
        ...
        fig.suptitle('HistGradientBoosting + PharmHGT Features - Area_min Prediction', fontsize=14)
